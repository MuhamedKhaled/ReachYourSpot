...
public class AboutTabFragment extends Fragment implements OnMapReadyCallback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Log.d("mashi", mCurrentPlace.getPlaceName());
    ...
    private void handleOnFavIconClicked(View rootView) {

        rootView.findViewById(R.id.location_favourite_container).setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void removeFromFavorites(){
        ...
        handleFavIconStatusChanges(false);
    }
    ...
    private void addToFavorites(){
        ...
        handleFavIconStatusChanges(true);

    }

    private void handleFavIconStatusChanges(Boolean isFav) {
        // True for add to Favorites
        if (isFav){
        ...
        // False for remove From Favorites
        else{
            mFavouriteImageIcon.setImageDrawable(ContextCompat
    ...
    private void handleOnOPenSite(View rootView) {
    ...
    private void handleOnPhoneCallClicked(final View rootView) {
    ...
    private void bindViews(View view){
        ...
        mLocationAddressTextView = (TextView) view.findViewById(R.id.location_address_text_view);
        mLocationPhoneTextView = (TextView) view.findViewById(R.id.location_phone_number_text_view);
        mLocationWebsiteTextView = (TextView) view.findViewById(R.id.location_website_text_view);
        mLocationOpeningStatusTextView = (TextView) view.findViewById(R.id.location_status_text_view);
        mFavouriteImageIcon = (ImageView) view.findViewById(R.id.location_favourite_icon);

        ((ImageView) view.findViewById(R.id.small_location_icon))
                .setColorFilter(ContextCompat.getColor(getActivity(), R.color.color_primary));
        ((ImageView) view.findViewById(R.id.small_phone_icon))
                .setColorFilter(ContextCompat.getColor(getActivity(), R.color.color_primary));
        ((ImageView) view.findViewById(R.id.small_website_icon))
                .setColorFilter(ContextCompat.getColor(getActivity(), R.color.color_primary));
        ((ImageView) view.findViewById(R.id.small_location_status_icon))
                .setColorFilter(ContextCompat.getColor(getActivity(), R.color.color_primary));
    }
    @Override
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        joinTwoPlace.geodesic(true).add(new LatLng(lat
                , lng))
